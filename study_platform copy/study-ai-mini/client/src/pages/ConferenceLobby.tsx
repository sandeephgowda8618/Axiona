...
import { Plus, ArrowRight, Users, Lock, Lightbulb, Save, Clipboard, Check } from 'lucide-react';
...
const ConferenceLobby: React.FC = () => {
  ...
  const generateRoomId = () => {
    // Generate a more readable 4-digit numeric code like STUDY-AI-7834
    const code = Math.floor(1000 + Math.random() * 9000);
    return `STUDY-AI-${code}`;
  };
  ...
  <main className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Main Actions */}
        <div className="flex flex-row gap-8 mb-12 justify-center items-center">
          {/* Create Room */}
          <div className="bg-white rounded-2xl shadow-lg border w-full" style={{ maxWidth: '300px', padding: '12px', backgroundColor: '#fee2e2' }}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex">
                  ...
                  <button
                    onClick={copyRoomId}
                    className="px-3 py-2 bg-gray-200 border border-l-0 border-gray-300 rounded-r-md hover:bg-gray-300 transition-colors flex items-center justify-center w-10"
          ...
          {/* Join Room */}
          <div className="bg-white rounded-2xl shadow-lg border w-full" style={{ maxWidth: '300px', padding: '12px', backgroundColor: '#dbeafe' }}>
            <div className="text-center mb-6">
  ...
  {/* Quick Tips */}
  <div className="bg-white rounded-2xl shadow-lg p-8 border max-w-[520px] mx-auto">
