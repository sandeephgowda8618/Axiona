...
export interface IStudyMaterial extends Document {
  ...
  fileSize: string;
  category: 'lecture-notes' | 'reference' | 'assignments' | 'textbooks' | 'question-papers';
  tags: string[];
  approved: boolean;
  ...
  // Methods
  incrementDownloadCount(): Promise<IStudyMaterial>;
  approve(): Promise<IStudyMaterial>;
  deactivate(): Promise<IStudyMaterial>;
}
...
StudyMaterialSchema.virtual('fileSizeBytes').get(function(this: IStudyMaterial) {
