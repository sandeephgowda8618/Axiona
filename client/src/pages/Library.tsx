    ...
    const fetchBooks = async () => {
      try {
        ...
        if (response.data.success && response.data.data) {
          ...
          setError('Failed to fetch books: ' + (response.data.message || 'Unknown error'))
                ...
                >
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-gray-900 mb-1 line-clamp-2 hover:text-blue-600 transition-colors">{book.title}</h3>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4 flex-1">
                      ...
                      />
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg font-semibold text-gray-900 mb-1 hover:text-blue-600 transition-colors">{book.title}</h3>
                        <p className="text-sm text-gray-600 mb-2">by {book.author}</p>
